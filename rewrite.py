...
def generate_title_and_seo(main_keywords, style):
    ...
    # Gọi ChatGPT
    response = openai.ChatCompletion.create(model=MODEL, messages=messages, temperature=0.8, max_tokens=100)
